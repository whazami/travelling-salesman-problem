...
class Affichage():
	...
	def displayStats(self):
		...
		self.turtleStats.write("Génération : " + str(algo.generation), False, "left", ("Arial", 10, "normal"))
...
file = GestionFichier("assets/villes.csv")
file.fill_villes()
...
while (not(algo.foundSolution())):
	...
	for i in range(algo.nbIndividus):
...
print("Meilleur résultat obtenu au bout de ", algo.generation, " générations :")
print(algo.meilleurCheminStrALL)
print("Distance totale parcourue : ", "%.2f" % algo.meilleurDistALL)
